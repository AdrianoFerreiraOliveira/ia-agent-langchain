...
class TalkingLLM():
    def __init__(self,  whisper_size= "small"):#model="gpt-3.5-turbo-0613"
    ...
    def create_agent(self):
        agent_prompt_prefix = """
            Você se chama Naruto, e está trabalhando com dataframe pandas no Python. O nome do Dataframe é `df`.
        """
    ...
    def run(self):
        ...
        with sd.InputStream(samplerate=self.samplerate, 
            ...
            hotkey = keyboard.HotKey(
                keyboard.HotKey.parse('0'), #<ctrl>+<alt>+h
                on_activate)
